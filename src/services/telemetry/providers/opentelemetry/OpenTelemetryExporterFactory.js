 ...
 */
export function createOTLPLogExporter(protocol, endpoint, insecure) {
    try {
        let exporter = null;
        switch (protocol) {
            case "grpc": {
 ...
 */
export function createOTLPMetricReader(protocol, endpoint, insecure, intervalMs, timeoutMs) {
    try {
        let exporter = null;
        switch (protocol) {
            case "grpc": {
