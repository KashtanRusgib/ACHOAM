...
const NETWORK_ERROR_MAP = new Map([
...
const STATUS_ERROR_MAP = new Map([
...
export class VoiceTranscriptionService {
    ...
    async transcribeAudio(audioBase64, language) {
        try {
            ...
            telemetryService.captureVoiceTranscriptionCompleted(undefined, // taskId
            result.text?.length, undefined, // duration
            language, isOrgAccount);
...
let _voiceTranscriptionServiceInstance = null;
export function getVoiceTranscriptionService() {
...
//# sourceMappingURL=VoiceTranscriptionService.js.map