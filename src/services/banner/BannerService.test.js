...
describe("BannerService", () => {
    ...
    beforeEach(() => {
        ...
        BannerService.reset();
        bannerService = BannerService.initialize(mockController);
    ...
    describe("API Provider Rule Evaluation", () => {
        it("should show banner when user has the required API provider configured", async () => {
            ...
            BannerService.reset();
            bannerService = BannerService.initialize(controllerWithOpenAI);
            const mockResponse = {
                data: {
                    data: {
                        items: [
                            {
                                ...
                                severity: "info",
                                placement: "top",
                                rulesJson: JSON.stringify({ providers: ["openai"] }),
                            },
                        ],
                    },
                },
        ...
        it("should NOT show banner when user doesn't have the required API provider", async () => {
            ...
            // Reinitialize with new controller
            BannerService.reset();
            bannerService = BannerService.initialize(controllerWithoutOpenAI);
            const mockResponse = {
                data: {
                    data: {
                        items: [
        ...
        it("should show banner if user has ANY of multiple specified providers", async () => {
            ...
            // Reinitialize with new controller
            BannerService.reset();
            bannerService = BannerService.initialize(controllerWithAnthropic);
            const mockResponse = {
                data: {
                    data: {
                        items: [
                            {
                                ...
                                severity: "info",
                                placement: "top",
                                rulesJson: JSON.stringify({ providers: ["anthropic", "openai"] }),
                            },
                        ],
                    },
                },
                        ...
                        items: [
                            {
                                ...
                                severity: "info",
                                placement: "top",
                                rulesJson: JSON.stringify({ audience: ["all"] }),
                            },
                        ],
                    },
                },
                        ...
                        items: [
                            {
                                ...
                                severity: "info",
                                placement: "top",
                                rulesJson: JSON.stringify({ audience: ["team_admin_only"] }),
                            },
                        ],
                    },
                },
                        ...
                        items: [
                            {
                                ...
                                severity: "info",
                                placement: "top",
                                rulesJson: JSON.stringify({ audience: ["team_members"] }),
                            },
                        ],
                    },
                },
                        ...
                        items: [
                            {
                                ...
                                severity: "info",
                                placement: "top",
                                rulesJson: JSON.stringify({ audience: ["personal_only"] }),
                            },
                        ],
                    },
                },
...
//# sourceMappingURL=BannerService.test.js.map