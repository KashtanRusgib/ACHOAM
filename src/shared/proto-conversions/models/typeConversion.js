 ...
 */
function convertThinkingConfig(protoConfig) {
    if (!protoConfig) {
        return undefined;
    }
    return {
 ...
 */
function toProtobufThinkingConfig(appConfig) {
    if (!appConfig) {
        return undefined;
    }
 ...
 */
export function fromProtobufModelInfo(protoInfo) {
    return {
 ...
 */
export function toProtobufModelInfo(modelInfo) {
 ...
 */
export function fromProtobufOpenAiCompatibleModelInfo(protoInfo) {
    return {
        maxTokens: protoInfo.maxTokens,
        contextWindow: protoInfo.contextWindow,
        supportsImages: protoInfo.supportsImages,
 ...
 */
export function fromProtobufLiteLLMModelInfo(protoInfo) {
    return {
        maxTokens: protoInfo.maxTokens,
        contextWindow: protoInfo.contextWindow,
        supportsImages: protoInfo.supportsImages,
 ...
 */
export function fromProtobufOcaModelInfo(protoInfo) {
    return {
        maxTokens: protoInfo.maxTokens,
        contextWindow: protoInfo.contextWindow,
        supportsImages: protoInfo.supportsImages,
 ...
 */
export function fromProtobufModels(protoModels) {
    const result = {};
 ...
 */
export function toProtobufModels(models) {
    const result = {};
