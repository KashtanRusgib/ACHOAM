...
import { ApiConfiguration, BotConfiguration, MultiBotConfiguration } from "./api"
 ...
 */
export function migrateFromLegacyConfig(legacyConfig: ApiConfiguration): MultiBotConfiguration {
	const defaultBot: BotConfiguration = {
		id: "default-head",
		name: "Main Agent",
 ...
 */
export function normalizeApiConfigurations(
	legacyConfig: ApiConfiguration | undefined,
	newConfigs: MultiBotConfiguration | undefined,
 ...
 */
export function getActiveBotConfiguration(configs: MultiBotConfiguration, preferredBotId?: string): BotConfiguration | undefined {
 ...
 */
export function getBotConfigurationById(configs: MultiBotConfiguration, botId: string): BotConfiguration | undefined {
 ...
 */
export function upsertBotConfiguration(configs: MultiBotConfiguration, bot: BotConfiguration): MultiBotConfiguration {
 ...
 */
export function removeBotConfiguration(configs: MultiBotConfiguration, botId: string): MultiBotConfiguration {
 ...
 */
export function toLegacyApiConfiguration(configs: MultiBotConfiguration): ApiConfiguration {
	if (!configs || configs.length === 0) {
