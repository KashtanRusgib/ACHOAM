...
import { AwsBedrockSettingsSchema, ClineSettingsSchema, OpenAiCompatibleSchema, RemoteConfigSchema, } from "../schema";
describe("Remote Config Schema", () => {
    describe("OpenAiCompatibleSchema", () => {
        ...
        it("should reject models with missing id field", () => {
            expect(() => OpenAiCompatibleSchema.parse({
    ...
    describe("ClineSettingsSchema", () => {
        ...
        it("should reject models with missing id field", () => {
            expect(() => ClineSettingsSchema.parse({
                models: [{}],
            })).to.throw();
        });
    });
    describe("AwsBedrockSettingsSchema", () => {
        ...
        it("should reject models with missing id field", () => {
            expect(() => AwsBedrockSettingsSchema.parse({
