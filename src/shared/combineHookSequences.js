 ...
 */
function isToolOrCommandMessage(msg) {
 ...
 */
function parseHookMetadata(hookMessage) {
 ...
 */
function filterPartialToolMessages(messages) {
 ...
 */
function combineHookWithOutputs(hookMessage, startIndex, messages) {
 ...
 */
function combineAllHooks(messages) {
    // Pass 1: Build map of combined hooks by timestamp
    const combinedHooksByTs = new Map();
 ...
 */
function findImmediateNextToolTimestamp(hookIndex, messages) {
 ...
 */
function buildPreToolUseMap(processedMessages, originalMessages) {
    const map = new Map();
 ...
 */
function reorderWithPreToolUseHooks(messages, preToolUseMap) {
    const result = [];
    const addedHooks = new Set();
 ...
 */
export function combineHookSequences(messages) {
...
//# sourceMappingURL=combineHookSequences.js.map