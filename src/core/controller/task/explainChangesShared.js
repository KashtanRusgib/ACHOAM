 ...
 */
export function buildDiffContent(changedFiles) {
	const parts = []
 ...
 */
export async function openDiffView(title, changedFiles) {
 ...
 */
export async function setupCommentController(apiConfiguration, changedFiles, conversationContext) {
 ...
 */
export function stringifyConversationHistory(apiConversationHistory) {
...
//# sourceMappingURL=explainChangesShared.js.map
