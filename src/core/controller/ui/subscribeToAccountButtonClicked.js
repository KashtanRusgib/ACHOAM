 ...
 */
export async function subscribeToAccountButtonClicked(_controller, _request, responseStream, requestId) {
 ...
 */
export async function sendAccountButtonClickedEvent() {
