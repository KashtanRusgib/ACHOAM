 ...
 */
export async function subscribeToSettingsButtonClicked(_controller, _request, responseStream, requestId) {
 ...
 */
export async function sendSettingsButtonClickedEvent() {
