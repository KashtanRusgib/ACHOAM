 ...
 */
export async function subscribeToHistoryButtonClicked(_controller, _request, responseStream, requestId) {
 ...
 */
export async function sendHistoryButtonClickedEvent() {
