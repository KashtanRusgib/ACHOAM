 ...
 */
export async function updateApiConfigurationPartial(controller, request) {
	try {
		// Validate request
		...
		for (const field of request.updateMask) {
			updatedConfig[field] = newConfigValues[field]
		}
...
//# sourceMappingURL=updateApiConfigurationPartial.js.map
