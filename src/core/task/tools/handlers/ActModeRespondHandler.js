...
export class ActModeRespondHandler {
    ...
    async execute(config, block) {
        ...
        if (config.mode !== "act") {
            ...
            return formatResponse.toolError(`The act_mode_respond tool is only available in ACT MODE. You are currently in ${config.mode.toUpperCase()} MODE. Please use the appropriate tool for your current mode.`);
        }
...
//# sourceMappingURL=ActModeRespondHandler.js.map