...
import { DiffError, PatchActionType } from "@/shared/Patch";
    ...
    describe("Parsing Logic", () => {
        const testCases = [
            ...
            // V4A Format: 3 lines of context above
            {
                ...
                currentFiles: {
                    "server.ts": "function processRequest(req: Request) {\n  const data = parseRequest(req)\n  const validated = validateData(data)\n  return oldHandler(validated)\n}",
                },
                expectedActions: {
                    "server.ts": {
                        type: PatchActionType.UPDATE,
            ...
            // V4A Format: Multiple changes with 3 lines context
            {
                ...
                currentFiles: {
                    "service.ts": "export class DataService {\n  private cache: Map<string, any>\n  \n  constructor() {\n    this.cache = new Map()\n  }\n  \n  async fetchData(key: string) {\n    if (this.cache.has(key)) {\n      return this.cache.get(key)\n    }\n    const data = await this.loadFromApi(key)\n    this.cache.set(key, data)\n    return data\n  }\n}",
                },
                expectedActions: {
                    "service.ts": {
                        type: PatchActionType.UPDATE,
            ...
            // V4A Format: @@ with class context plus 3 lines
            {
                ...
                currentFiles: {
                    "models.ts": "class UserModel extends EventEmitter {\n  id: string\n  name: string\n  \n  async save(): Promise<void> {\n    await validateUser(this)\n    await db.insert('users', this.toJSON())\n    this.emit('saved')\n  }\n  \n  async delete(): Promise<void> {\n    await db.delete('users', this.id)\n  }\n}",
                },
                expectedActions: {
                    "models.ts": {
                        type: PatchActionType.UPDATE,
...
//# sourceMappingURL=PatchParser.test.js.map