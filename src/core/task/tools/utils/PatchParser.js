import { DiffError, PATCH_MARKERS, PatchActionType, } from "@/shared/Patch";
...
function findContext(lines, context, start, eof) {
    ...
    const findCore = (startIdx) => {
        ...
        for (let i = startIdx; i < lines.length; i++) {
            const segment = canonicalize(lines
