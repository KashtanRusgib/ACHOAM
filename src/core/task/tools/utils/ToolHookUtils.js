...
export class ToolHookUtils {
     ...
     */
    static async runPreToolUseIfEnabled(config, block) {
     ...
     */
    static addHookContextToConversation(config, contextModification, source) {
...
//# sourceMappingURL=ToolHookUtils.js.map