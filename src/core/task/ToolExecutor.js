...
export class ToolExecutor {
    ...
    context, taskState, messageStateHandler, api, urlContentFetcher, browserSession, diffViewProvider, mcpHub, fileContextTracker, clineIgnoreController, contextManager, stateManager, 
    // Configuration & Settings
    cwd, taskId, ulid, vscodeTerminalExecutionMode, 
    // Workspace Management
    workspaceManager, isMultiRootEnabled, 
    // Callbacks to the Task (Entity)
    say, ask, saveCheckpoint, sayAndCreateMissingParamError, removeLastPartialMessageIfExistsWithType, executeCommandTool, doesLatestTaskCompletionHaveNewChanges, updateFCListFromToolResponse, switchToActMode, cancelTask, 
    // Atomic hook state helpers from Task
    setActiveHookExecution, clearActiveHookExecution, getActiveHookExecution, runUserPromptSubmitHook) {
        ...
        this.taskId = taskId;
        this.ulid = ulid;
        this.vscodeTerminalExecutionMode = vscodeTerminalExecutionMode;
        this.workspaceManager = workspaceManager;
        this.isMultiRootEnabled = isMultiRootEnabled;
        this.say = say;
        this.ask = ask;
        ...
        this.switchToActMode = switchToActMode;
        this.cancelTask = cancelTask;
        this.setActiveHookExecution = setActiveHookExecution;
        this.clearActiveHookExecution = clearActiveHookExecution;
        this.getActiveHookExecution = getActiveHookExecution;
        this.runUserPromptSubmitHook = runUserPromptSubmitHook;
     ...
     */
    async applyLatestBrowserSettings() {
    ...
    pushToolResult = (content, block) => {
        ...
        ToolResultUtils.pushToolResult(content, block, this.taskState.userMessageContent, (block) => ToolDisplayUtils.getToolDescription(block), this.api, () => {
            this.taskState.didAlreadyUseTool = true;
        }, this.coordinator, this.taskState.toolUseIdMap);
    };
    /**
    ...
    async execute(block) {
        ...
        try {
            ...
            if (this.stateManager.getGlobalSettingsKey("strictPlanModeEnabled") &&
     ...
     */
    addHookContextToConversation(contextModification, source) {
     ...
     */
    async runPostToolUseHook(block, toolResult, executionSuccess, executionStartTime) {
