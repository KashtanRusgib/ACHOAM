...
describe("TaskResume Hook", () => {
    ...
    const writeHookScript = async (hookPath, nodeScript) => {
...
console.log(JSON.stringify({
  ...
  contextModification: "PROJECT_NOTE: " + count + " messages in history"
    ...
    describe("Fixture-Based Tests", () => {
        const loadFixtureAndCreateRunner = async (fixtureName) => {
...
//# sourceMappingURL=taskresume.test.js.map