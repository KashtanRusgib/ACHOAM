 ...
 */
export function isValidHookType(hookName) {
    return VALID_HOOK_TYPES.includes(hookName);
}
/**
 ...
 */
export async function resolveHooksDirectory(isGlobal, workspaceName, globalHooksDirOverride) {
    if (isGlobal) {
