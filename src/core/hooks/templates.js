...
function getTaskResumeTemplate() {
    return `#!/bin/bash
#
# TaskResume Hook
# 
...
function getTaskCancelTemplate() {
    return `#!/bin/bash
#
# TaskCancel Hook
# 
...
function getTaskCompleteTemplate() {
    return `#!/bin/bash
#
# TaskComplete Hook
# 
...
function getPreToolUseTemplate() {
    return `#!/bin/bash
#
# PreToolUse Hook
# 
...
function getPostToolUseTemplate() {
    return `#!/bin/bash
#
# PostToolUse Hook
# 
...
function getUserPromptSubmitTemplate() {
    return `#!/bin/bash
#
...
function getPreCompactTemplate() {
    return `#!/bin/bash
#
# PreCompact Hook
# 
...
function getDefaultTemplate(hookName) {
    return `#!/bin/bash
#
# ${hookName} Hook
# 
