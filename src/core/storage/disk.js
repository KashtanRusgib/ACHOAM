...
export async function saveApiConversationHistory(taskId, apiConversationHistory) {
    try {
        const filePath = path.join(await ensureTaskDirectoryExists(taskId), GlobalFileNames.apiConversationHistory);
...
export async function getSavedClineMessages(taskId) {
...
export async function saveClineMessages(taskId, uiMessages) {
    try {
