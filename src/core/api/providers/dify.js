        ...
        try {
            while (true) {
                ...
                if (done) {
                    ...
                    console.log("[DIFY DEBUG] Final state - hasYieldedContent:", hasYieldedContent, "fullText length:", fullText.length, "processedEvents:", processedEvents);
                    break;
                }
                ...
                for (const line of lines) {
                    ...
                    if (line.startsWith("data: ")) {
                        ...
                        console.log("[DIFY DEBUG] Non-data line (not starting with 'data:'), trying to parse as direct JSON:", JSON.stringify(line));
            ...
            if (!hasYieldedContent) {
                ...
                if (fullText.trim()) {
                    ...
                    throw new Error(`Dify API did not provide any assistant messages. ` +
