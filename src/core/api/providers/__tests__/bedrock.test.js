    ...
    describe("getModelId", () => {
        it("should return raw model ID for custom models", async () => {
            const customOptions = {
                ...
                apiModelId: "arn:aws:bedrock:us-west-2:123456789012:custom-model/anthropic.claude-3-5-sonnet-20241022-v2:0/Qk8MMyLmRd",
            };
            const customHandler = new AwsBedrockHandler(customOptions);
            const modelId = await customHandler.getModelId();
            modelId.should.equal("arn:aws:bedrock:us-west-2:123456789012:custom-model/anthropic.claude-3-5-sonnet-20241022-v2:0/Qk8MMyLmRd");
        });
        ...
        it("should not apply cross-region prefix for custom models even when enabled", async () => {
            const customCrossRegionOptions = {
                ...mockOptions,
                awsBedrockCustomSelected: true,
