import { CLAUDE_SONNET_1M_SUFFIX, openRouterClaudeSonnet41mModelId, openRouterClaudeSonnet451mModelId, } from "@shared/api";
import { convertToOpenAiMessages } from "../transform/openai-format";
import { getOpenAIToolParams } from "./tool-call-processor";
export async function createVercelAIGatewayStream(client, systemPrompt, messages, model, thinkingBudgetTokens, tools) {
