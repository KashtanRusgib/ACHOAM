import { CLAUDE_SONNET_1M_SUFFIX, OPENROUTER_PROVIDER_PREFERENCES, openRouterClaudeSonnet41mModelId, openRouterClaudeSonnet451mModelId, } from "@shared/api";
import { shouldSkipReasoningForModel } from "@utils/model-utils";
import { convertToOpenAiMessages } from "./openai-format";
import { convertToR1Format } from "./r1-format";
import { getOpenAIToolParams } from "./tool-call-processor";
export async function createOpenRouterStream(client, systemPrompt, messages, model, reasoningEffort, thinkingBudgetTokens, openRouterProviderSorting, tools, geminiThinkingLevel) {
