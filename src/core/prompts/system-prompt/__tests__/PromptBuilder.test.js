            ...
            const customComponents = {
                ...
                SYSTEM_INFO_SECTION: async (variant) => {
                    ...
                    if (typeof template === "function") {
                        const mockContext = { cwd: "/test", yoloModeToggled: false };
    ...
    describe("VariantBuilder auto-generation", () => {
        it("should auto-generate baseTemplate from componentOrder when not provided", () => {
            const config = createVariant(ModelFamily.GENERIC)
                ...
                .version(1)
                .components(SystemPromptSection.AGENT_ROLE, SystemPromptSection.TOOL_USE, SystemPromptSection.CAPABILITIES, SystemPromptSection.RULES)
                .matcher(() => true)
                .build();
