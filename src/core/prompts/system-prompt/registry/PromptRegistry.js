...
export class PromptRegistry {
    ...
    performHealthCheck() {
        ...
        console.log(`Registry health check: ${this.variants.size} variants, ${Object.keys(this.components).length} components loaded`);
    }
    ...
    async get(context) {
        ...
        if (!variant) {
            ...
            throw new Error(`No prompt variant found for model '${context.providerInfo.model.id}' and no generic fallback available. ` +
