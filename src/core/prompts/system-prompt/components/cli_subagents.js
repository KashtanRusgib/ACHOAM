...
const getCliSubagentsTemplateText = (_context) => `USING THE CLINE CLI TOOL
...
export async function getCliSubagentsSection(variant, context) {
...
//# sourceMappingURL=cli_subagents.js.map