...
const GEMINI_3_OBJECTIVE_TEMPLATE = (context) => `OBJECTIVE
...
const GEMINI_3_EDITING_FILES_TEMPLATE = (_context) => `EDITING FILES
...
const GEMINI_3_RULES_TEMPLATE = (_context) => `RULES
...
const GEMINI_3_FEEDBACK_TEMPLATE = (_context) => `FEEDBACK
...
const GEMINI_3_ACT_VS_PLAN_TEMPLATE = (context) => `ACT MODE V.S. PLAN MODE
...
const GEMINI_3_UPDATING_TASK_PROGRESS_TEMPLATE = (context) => `UPDATING TASK PROGRESS
