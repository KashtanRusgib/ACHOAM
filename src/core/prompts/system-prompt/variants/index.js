 ...
 * and use cases.
 */
export { config as Gemini3Config } from "./gemini-3/config";
export { config as genericConfig } from "./generic/config";
export { config as glmConfig } from "./glm/config";
export { config as gpt5Config } from "./gpt-5/config";
export { config as hermesConfig } from "./hermes/config";
export { config as microwaveConfig } from "./microwave/config";
export { config as NativeGPT5Config } from "./native-gpt-5/config";
export { config as NativeGPT51Config } from "./native-gpt-5-1/config";
export { config as nativeNextGenConfig } from "./native-next-gen/config";
...
import { config as microwaveConfig } from "./microwave/config";
...
export const VARIANT_CONFIGS = {
    ...
    /*** Microwave variant - Optimized for MICROWAVE stealth model family
     * Configured for vendor specific message
     */
    [ModelFamily.MICROWAVE]: microwaveConfig,
    /**
