...
export const newTaskToolResponse = (enableNativeToolCalls) => {
...
`;
export const subagentToolResponse = () => `<explicit_instructions type="subagent">
...
`;
export const explainChangesToolResponse = () => `<explicit_instructions type="explain_changes">
 ...
 */
export const deepPlanningToolResponse = (focusChainSettings, providerInfo, enableNativeToolCalls) => {
