...
export async function generateCommitMsg(stateManager, scm) {
	try {
...
async function orchestrateWorkspaceCommitMsgGeneration(stateManager, repos) {
...
async function generateCommitMsgForRepository(stateManager, repository) {
...
async function performCommitMsgGeneration(stateManager, gitDiff, inputBox) {
	try {
