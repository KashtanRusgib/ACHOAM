...
describe("Hook Management Integration", () => {
    ...
    let tempDir;
    let globalHooksDir;
    let workspaceHooksDir;
    let mockController;
    let stateManagerStub;
    let getWorkspacePathsStub;
    beforeEach(async () => {
    ...
    describe("Complete Hook Lifecycle", () => {
        ...
        it("should handle multiple global hooks with independent states", async function () {
            ...
            await createHook(mockController, CreateHookRequest.create({
                hookName: "TaskStart",
                isGlobal: true,
            }), globalHooksDir);
            await createHook(mockController, CreateHookRequest.create({
            ...
            // Enable two of them
            await toggleHook(mockController, ToggleHookRequest.create({
                hookName: "TaskStart",
                isGlobal: true,
                enabled: true,
            }), globalHooksDir);
            ...
            await deleteHook(mockController, DeleteHookRequest.create({
                hookName: "TaskStart",
                isGlobal: true,
            }), globalHooksDir);
            await deleteHook(mockController, DeleteHookRequest.create({
...
//# sourceMappingURL=hook-management-integration.test.js.map