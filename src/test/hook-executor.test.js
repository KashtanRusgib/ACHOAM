...
describe("Hook Executor", () => {
    ...
    let tempDir;
    let baseTempDir; // Store base directory for cleanup
    let testHandler;
    let mockMessages;
     ...
     */
    async function createHookScript(hookName, output, exitCode = 0, delayMs = 0) {
...
`;
    ...
    describe("Basic Hook Execution", () => {
        ...
        it("should execute hook successfully and return result", async function () {
            ...
            sayMessages.should.matchAny((msg) => msg.type === "hook");
        });
